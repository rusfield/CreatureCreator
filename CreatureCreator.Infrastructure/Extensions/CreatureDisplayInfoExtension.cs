...
namespace CreatureCreator.Infrastructure.Extensions
{
    public static class CreatureDisplayInfoExtension
    {
        ...
        public static int? GetModelIdByRaceAndGenders(this CreatureDisplayInfoExtra creatureDisplayInfoExtra, DisplayRaces displayRace, Genders Genders, bool upright = true)
        {
            ...
            return (displayRace, Genders) switch
            {
                ...
                (DisplayRaces.ORC, Genders.Male) => upright ? 10882 : 6838,
                ...
                (DisplayRaces.MAGHAR_ORC, Genders.Male) => upright ? 10883 : 10844, // Referencing orc?
                (DisplayRaces.MAGHAR_ORC, Genders.Female) => 10845, // Referencing orc?
